...
previously generated files that still carry the marker but are no longer
needed. A handwritten file at the same path as a current generated file is
still overwritten. External domains need `--skel-import`, plus language-specific
import mappings.
