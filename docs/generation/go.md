...
skelc v0.12.x through v0.14.x support rolling upgrades with Go packages
generated by v0.11.x. Regenerate imported packages incrementally, and finish
the migration before upgrading to v0.15.0, when imported generated data must
