...
skelc v0.12.0 supports rolling upgrades with Go packages generated by v0.11.x.
Regenerate imported packages incrementally, and complete the migration before
