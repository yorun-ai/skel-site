...
Development config fields can use [`@noTrim`](/docs/metadata) to preserve string whitespace, including alongside `@sensitive`. This requires Vine v0.15.0 or later.
